...
router.post("/register-owner", async (req, res) => {
    ...
    const obOwner = new Owner({ first_name, last_name, age, id_number, email, phone_number, password });
    ...
    client.query(checkSql, [obOwner.email, obOwner.phone_number, obOwner.id_number], async (err, rows) => {
        if (err) {
        ...
        try {
            ...
            client.query(insertSql, [obOwner.first_name, obOwner.last_name, obOwner.age, obOwner.id_number, obOwner.email, obOwner.phone_number, obOwner.password], (err, results) => {
                if (err) {
...
router.get("/get-owners", (req, res) => {
    const sql = "SELECT id, first_name, last_name, email, phone_number FROM owners";
